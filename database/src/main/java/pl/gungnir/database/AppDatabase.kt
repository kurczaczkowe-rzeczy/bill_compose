...
abstract class AppDatabase : RoomDatabase() {
    ...
    private class DatabaseCallback(
        ...
        private fun createCategories(): List<CategoryEntity> {
            return listOf(
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_meat),
                    colorCategory = Color.parseColor("#FF4F4F"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_bread),
                    colorCategory = Color.parseColor("#FFB84F"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_seafood),
                    colorCategory = Color.parseColor("#4FCAFF"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_vegetables),
                    colorCategory = Color.parseColor("#3DC753"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_dairy),
                    colorCategory = Color.parseColor("#C6C85A"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_XXX),
                    colorCategory = Color.parseColor("#C9642C"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_spices),
                    colorCategory = Color.parseColor("#FC65FF"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_canned),
                    colorCategory = Color.parseColor("#979797"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_alcohol),
                    colorCategory = Color.parseColor("#C9482C"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_chemicals),
                    colorCategory = Color.parseColor("#874FFF"),
                    isPremadeCategory = true
                ),
                CategoryEntity(
                    nameCategory = context.getString(string.category_name_other),
